...
List<SettingsModel> get videoSettings => [
  SwitchModel(
    title: uiTx('开启硬解'),
    subtitle: uiTx('以较低功耗播放视频，若异常卡死请关闭'),
  ...
  NormalModel(
    title: uiTx('B站定向流量支持'),
    subtitle: uiTx('若套餐含B站定向流量，则会自动使用。可查阅运营商的流量记录确认。'),
  ...
  SwitchModel(
    ...
    subtitle: uiTx('测速通过模拟加载视频实现，注意流量消耗，结果仅供参考'),
    setKey: SettingBoxKey.cdnSpeedTest,
    defaultVal: true,
  ),
  SwitchModel(
    title: uiTx('音频不跟随 CDN 设置'),
    subtitle: uiTx('直接采用备用 URL，可解决部分视频无声'),
