...
- **選擇 App 語言。** 預設為簡體中文。約 35 種語言，包含English、日本語、한국어、Français、Deutsch、Español、Italiano、Русский、ไทย、Tiếng Việt、Bahasa Melayu／Bahasa Indonesia、Filipino、Türkçe、العربية、עברית、བོད་སྐད་、Монгол хэл、ئۇيغۇرچە、Vahcuengh、简体粤语、繁體粵語、吳語、大陆闽南语、臺灣閩南語）。
